...
contract BakeVaultOnMacaron is Ownable, Pausable {
    ...
    struct UserInfo {
        ...
        uint256 bakeAtLastUserAction; // keeps track of bake deposited at the last user action
        uint256 lastUserActionTime; // keeps track of the last user action time
    }

    IERC20 public immutable token; // Bake token
    ...
    /**
     * @notice Constructor
     * @param _token: Bake token contract
    ...
    /**
     * @notice Deposits funds into the Bake Vault
     * @dev Only possible when contract not paused.
     * @param _amount: number of tokens to deposit (in BAKE)
     */
    function deposit(uint256 _amount) external whenNotPaused notContract {
        ...
        user.bakeAtLastUserAction = user.shares.mul(balanceOf()).div(totalShares);
    ...
    /**
     * @notice Reinvests BAKE tokens into MasterChef
     * @dev Only possible when contract not paused.
     */
    ...
    /**
     * @notice Withdraw unexpected tokens sent to the Bake Vault
     */
    ...
    /**
     * @notice Withdraws from funds from the Bake Vault
    ...
    function balanceOf() public view returns (uint256) {
        (uint256 amount, ) = IMasterChef(masterchef).poolUserInfoMap(address(token), address(this));
